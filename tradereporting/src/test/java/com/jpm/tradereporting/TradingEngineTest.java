...
public class TradingEngineTest extends TestCase {
	...
	private List<Holidays> cookupHolidayData() {
		...
		holidays.add(new Holidays("SAR", Set.of(new Integer[] { Calendar.FRIDAY, Calendar.SATURDAY })));
	...
	public void testTradingEngine() throws Exception {
		List<Message> messages1 = createTestMessage1(product1, Start.THURSDAY, Start.FRIDAY);
		...
		List<Message> messages2 = createTestMessage1(product2, Start.FRIDAY, Start.SUNDAY);
		...
		List<Message> messages3 = createTestMessage1(product3, Start.SATURDAY, Start.MONDAY);
	...
	private void assertReportAndRank(String product, List<Object> reportedMessages) {
		if (product.equals(product1)) {
			assertEquals("Total Outgoing Amount 147.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(0));
			assertEquals("Total Incoming Amount 230.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(1));
			...
			assertEquals("Total Outgoing Amount 588.0 in USD settled for DateFri Aug 31 00:00:00 BST 2018",reportedMessages.get(0));
			assertEquals("Total Outgoing Amount 147.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(1));
			assertEquals("Total Incoming Amount 920.0 in USD settled for DateFri Aug 31 00:00:00 BST 2018",reportedMessages.get(2));
			assertEquals("Total Incoming Amount 230.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(3));
			...
			assertEquals("Total Outgoing Amount 1323.0 in USD settled for DateSat Sep 01 00:00:00 BST 2018",reportedMessages.get(0));
			assertEquals("Total Outgoing Amount 588.0 in USD settled for DateFri Aug 31 00:00:00 BST 2018",reportedMessages.get(1));
			assertEquals("Total Outgoing Amount 147.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(2));
			assertEquals("Total Incoming Amount 2070.0 in USD settled for DateSat Sep 01 00:00:00 BST 2018",reportedMessages.get(3));
			assertEquals("Total Incoming Amount 920.0 in USD settled for DateFri Aug 31 00:00:00 BST 2018",reportedMessages.get(4));
			assertEquals("Total Incoming Amount 230.0 in USD settled for DateThu Aug 30 00:00:00 BST 2018",reportedMessages.get(5));
	...
	private void assertProcessedMessage(String product, List<Message> messages) {
		...
		if (product.equals(product1)) {
			...
			// SAR and AED
			assertEquals("02 Sep 2018", format.format(messages.get(0).getAdjustedSettlementDate()));
			assertEquals("02 Sep 2018", format.format(messages.get(1).getAdjustedSettlementDate()));
			assertEquals("02 Sep 2018", format.format(messages.get(2).getAdjustedSettlementDate()));
			assertEquals("02 Sep 2018", format.format(messages.get(3).getAdjustedSettlementDate()));
			// GBP
			assertEquals("31 Aug 2018", format.format(messages.get(4).getAdjustedSettlementDate()));
			assertEquals("31 Aug 2018", format.format(messages.get(5).getAdjustedSettlementDate()));
		} else if (product.equals(product2)) {
			...
			assertEquals("02 Sep 2018", format.format(messages.get(3).getAdjustedSettlementDate()));
			// GBP
			assertEquals("03 Sep 2018", format.format(messages.get(4).getAdjustedSettlementDate()));
			assertEquals("03 Sep 2018", format.format(messages.get(5).getAdjustedSettlementDate()));
		} else if (product.equals(product3)) {
			...
			// SAR and AED
			assertEquals("03 Sep 2018", format.format(messages.get(0).getAdjustedSettlementDate()));
			assertEquals("03 Sep 2018", format.format(messages.get(1).getAdjustedSettlementDate()));
			assertEquals("03 Sep 2018", format.format(messages.get(2).getAdjustedSettlementDate()));
			assertEquals("03 Sep 2018", format.format(messages.get(3).getAdjustedSettlementDate()));
			// GBP
			assertEquals("03 Sep 2018", format.format(messages.get(4).getAdjustedSettlementDate()));
			assertEquals("03 Sep 2018", format.format(messages.get(5).getAdjustedSettlementDate()));
		}
	...
	private List<Message> createTestMessage1(String product, String instrDate, String settlementDate) throws Exception {
		...
		messages.add(1,
				new DefaultMessage(product, Side.SELL, 1.33, "SAR", instrDate, settlementDate, units, pricePerUnit));
		messages.add(2,
